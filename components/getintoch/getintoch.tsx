...
const GetTouch = () => {
  return (
    <div className="bg-getintoch">
      ...
      <div className="max-w-screen-xl mt-24 px-8 grid gap-8 grid-cols-1 bg-white md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto text-gray-900 rounded-lg shadow-lg">
        ...
        <div className="">
          ...
          <div className="mt-8">
            <button className="uppercase text-sm font-bold tracking-wide bg-yellow-300 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline">
              Send Message
            </button>
          </div>
        </div>
